...
Welcome to the Echo Data Marketplace App! This guide will walk you through the setup process and introduce you to the foundational concepts that power the application. This app utilizes the Ocean Protocol on the Taraxa blockchain to facilitate a marketplace for Telegram data. You can find the market UI for the [Oceanprotocol stack](https://oceanprotocol.com/) at [market.echo-social](https://market.echo-social.io/).

## Prerequisites

- Install [Node.js](https://nodejs.org/en/) (v12.x or higher recommended)
- Git
